...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, trimLeft = c(30, 30), truncLen=c(280, 180),
...
### Save data
save(out, seqtab.nochim, freq.nochim, track, taxam, file = "SRKW-diet-ALL+2024.Rdata")
