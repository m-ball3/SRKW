...
load("DADA2/DADA2 Outputs/SRKW-diet-16SP4.Rdata")

# Gets sample metadata
samdf <- read.csv("metadata/Plate4/SRKW_Diet_Plate4_MetaData.csv")
...
#saves plots 
ggsave("Deliverables/Plate4/srkw-species.png", plot = sp.rel.plot, width = 16, height = 8, units = "in", dpi = 300)

ggsave("Deliverables/Plate4/srkw-genus.png", plot = gen.rel.plot, width = 16, height = 8, units = "in", dpi = 300)

ggsave("Deliverables/Plate4/srkw-family.png", plot = fam.rel.plot, width = 16, height = 8, units = "in", dpi = 300)

ggsave("Deliverables/Plate4/srkw-sp-bypod.png", plot = pod.faucet, width = 16, height = 8, units = "in", dpi = 300)
# ------------------------------------------------------------------
# TABLES
# ------------------------------------------------------------------
...
# Writes to CSV
write.csv(otu.abs, "./Deliverables/Plate4/SRKW_absolute_speciesxsamples.csv", row.names = FALSE)
write.csv(otu.prop, "./Deliverables/Plate4/SRKW_relative_speciesxsamples.csv", row.names = FALSE)
